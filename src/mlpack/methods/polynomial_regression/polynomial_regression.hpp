/**
 * @file methods/polynomial_regression/polynomial_regression.hpp
 * @author Nippun Sharma
 *
 * Simple least-squares polynomial regression.
 *
 ...
 */
#ifndef MLPACK_METHODS_POLYNOMIAL_REGRESSION_POLYNOMIAL_REGRESSION_HPP
#define MLPACK_METHODS_POLYNOMIAL_REGRESSION_POLYNOMIAL_REGRESSION_HPP
...
/**
 * A simple polynomial regression algorithm using ordinary least squares.
...
class PolynomialRegression
{
 public:
   ...
   * Predict()!
   */
  PolynomialRegression() : lambda(0.0), intercept(true) { }
